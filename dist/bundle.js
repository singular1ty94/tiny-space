...
var _pirates = __webpack_require__(30);

var _planets = __webpack_require__(31);
    ...
    _createClass(Game, [{
        ...
        value: function upgrade() {
            ...
            if (this.state.commodities >= upgrade.cost) {
                ...
                this.setState({
                    logs: [].concat(_toConsumableArray(this.state.logs), ['Cannot afford the upgrade level!'])
                });
            }
        }
    }, {
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(11),A=__webpack_require__(3),B=__webpack_require__(2),ca=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),ha=__webpack_require__(15),ia=__webpack_require__(16),C=__webpack_require__(4);
...
var _BuildMenu = __webpack_require__(35);
...
var _UpgradeMenu = __webpack_require__(36);
...
var _ResourceMenu = __webpack_require__(37);

Object.keys(_ResourceMenu).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ResourceMenu[key];
    }
  });
});
...
var BuildMenu = exports.BuildMenu = function (_React$Component) {
    _inherits(BuildMenu, _React$Component);

    function BuildMenu() {
        _classCallCheck(this, BuildMenu);

        return _possibleConstructorReturn(this, (BuildMenu.__proto__ || Object.getPrototypeOf(BuildMenu)).apply(this, arguments));
    }

    _createClass(BuildMenu, [{
        key: "render",
        value: function render() {
            var _this2 = this;
            ...
            return React.createElement(
                ...
                React.createElement(
                    "div",
                    { id: "slideout", className: this.props.active ? 'on' : null },
                    React.createElement(
                        "h4",
                        { onClick: function onClick() {
                                return _this2.props.toggleMenu();
                    ...
                    this.props.addons.map(function (x, i) {
                        return React.createElement(
                            "div",
...
exports.ResourceMenu = undefined;
...
var ResourceMenu = exports.ResourceMenu = function (_React$Component) {
    _inherits(ResourceMenu, _React$Component);

    function ResourceMenu(props) {
        _classCallCheck(this, ResourceMenu);

        var _this = _possibleConstructorReturn(this, (ResourceMenu.__proto__ || Object.getPrototypeOf(ResourceMenu)).call(this, props));
    ...
    _createClass(ResourceMenu, [{
        key: 'render',
        value: function render() {
            var _this2 = this;

            var resourcesNotCollected = _resources.resourceList.filter(function (res) {
                return !_this2.props.resources.includes(res);
            });
            var allResources = [].concat(this.props.resources, resourcesNotCollected);
            return React.createElement(
                'div',
                { id: 'bottomRightUI' },
                React.createElement(
                ...
                React.createElement(
                    'div',
                    { id: 'slideoutResources', className: this.props.active ? 'on' : null },
                    React.createElement(
                        'h4',
                        { onClick: function onClick() {
                                return _this2.props.toggleMenu();
                    ...
                    allResources.slice(this.state.offset, this.state.offset + 6).map(function (x, i) {
                        if (_this2.props.resources.includes(x)) {
                            return React.createElement(
                                'div',
                                { className: 'resourceSquare', key: i },
                                React.createElement(
                                    'span',
                                    null,
                                    x.name,
                                ...
                                React.createElement(
                                    'button',
                                    { className: 'button-primary', title: 'Sell' },
                                    'Sell: ',
                                    x.resale
                                )
                            );
                    ...
                    React.createElement(
                        'div',
                        { className: 'resources-controls' },
                        React.createElement(
                            'span',
                            {
                                onClick: function onClick() {
                                    return _this2.state.offset > 0 && _this2.setState({ offset: _this2.state.offset - 6 });
                                }
                            },
                            '<< Prev Page'
                        ),
                        React.createElement(
                            'span',
                            { onClick: function onClick() {
                                    return _this2.setState({ offset: _this2.state.offset + 6 });
                                } },
                            'Next Page >>'
                        )
                    )
    ...
    _createClass(GalacticSystem, [{
        ...
        value: function clickEvent(e) {
            ...
            this.meteors.forEach(function (m) {
                if (coords.x >= m.x - m.image.width / 2 && coords.x <= m.x + m.image.width / 2 && coords.y >= m.y - m.image.height / 2 && coords.y <= m.y + m.image.height / 2) {
                    // Time to mine some ore!
                    if (!m.dry) {
                        var res = _resources.resourceList.filter(function (r) {
                            return r.rarity == _this2.props.base.rarity && r.type == _resources.TYPE.METAL;
                        });
                        var mine = res[(0, _helpers.getRandom)(0, res.length - 1)];
                        _this2.popup('You extracted ' + mine.name + '!', coords.x, coords.y);
                        _this2.props.gain(mine);
                        m.dry = true;
                    } else {
                        _this2.popup('The asteroid is empty...', coords.x, coords.y);
                    }
                }
            });
        }
        ...
        value: function componentDidMount() {
            ...
            for (var i = 0; i < numMeteors; i++) {
                ...
                this.meteors[i] = {
                    image: meteor,
                    x: (0, _helpers.getRandom)(30, window.innerWidth - 30),
                    y: (0, _helpers.getRandom)(30, window.innerHeight - 30),
                    degrees: 0,
                    dry: false
                };
            }
